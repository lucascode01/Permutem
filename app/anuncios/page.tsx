...
export default function AnunciosPage() {
  ...
  const anuncios = [
    ...
    {
      id: 2,
      titulo: 'Casa com jardim na Barra da Tijuca',
      tipo: 'Casa',
      preco: 'R$ 1.200.000',
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <div className="flex items-center mt-1 text-gray-500 text-sm">
                        ...
                        <span>Atualizado em {anuncio.dataAtualizacao}</span>
                      </div>
                    </div>
                  ...
                  <div className="mt-2 flex flex-wrap">
                    <div className="mr-6 mb-2 flex items-center text-gray-700">
                      ...
                      <span className="font-medium">{anuncio.preco}</span>
                    </div>
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-100 flex justify-between items-center">
                    <div className="flex items-center text-sm text-gray-500">
                      ...
                      <span className="flex items-center">
                        ...
                        {anuncio.propostas} {anuncio.propostas === 1 ? 'proposta' : 'propostas'}
                      </span>
                    </div>
