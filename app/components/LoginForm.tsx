                ...
                <>
                  <div className="space-y-3">
                    ...
                    <button 
                      ...
                      className="w-full flex items-center justify-center py-3 px-4 border border-gray-300 rounded-lg font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 transition-colors"
                      disabled={loading}
                    >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0071ce]"
                  ...
                  <div className="flex items-center justify-between mt-6">
                    <div className="flex items-center">
                      <input
                        ...
                        className="h-4 w-4 text-[#0071ce] focus:ring-[#0071ce] border-gray-300 rounded"
                      />
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#0071ce] hover:bg-[#005fad] text-white font-medium py-3 px-4 rounded-lg transition-colors mt-4"
                    disabled={loading}
                  >
                  ...
                  <div className="flex items-center justify-center mt-4">
                    <button
                      ...
                      className="text-sm text-gray-500 hover:text-[#0071ce]"
                    >
