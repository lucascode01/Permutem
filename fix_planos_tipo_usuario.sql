...
SELECT id, nome, tipo_usuario, periodo FROM planos;
...
CREATE TABLE planos_temp (
  ...
  tipo_usuario TEXT NOT NULL,  -- STRING em vez de ARRAY
...
-- Remover todos os planos existentes
TRUNCATE TABLE planos;

-- Alterar a estrutura da tabela planos para ter tipo_usuario como TEXT em vez de TEXT[]
ALTER TABLE planos DROP COLUMN tipo_usuario;
ALTER TABLE planos ADD COLUMN tipo_usuario TEXT NOT NULL;

-- Inserir planos para proprietários com tipo_usuario como string
...
-- Inserir planos para corretores com tipo_usuario como string
INSERT INTO planos (id, nome, descricao, valor_mensal, valor_anual, max_anuncios, recursos, ativo, ordem, destaque, tipo_usuario, periodo, preco, limite_imoveis)
VALUES
...
-- Inserir plano para administradores com tipo_usuario como string
INSERT INTO planos (id, nome, descricao, valor_mensal, valor_anual, max_anuncios, recursos, ativo, ordem, destaque, tipo_usuario, periodo, preco, limite_imoveis)
VALUES
